...
namespace mBikeEcommerce.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Filter(string cond, string name)
        {
            if (cond == "brand")
            {
        ...
        public ActionResult Create([Bind(Include = "ID,brand,type,name,imgPath,price,description")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,brand,type,name,imgPath,price,description")] Product product)
        {
            if (ModelState.IsValid)
            {
